...
alignment. Make sure to delete them before running `codeml`.
...
2. Are your sequences evolving under positive selection at a level of 0.05? Instead of comparing the critical value with the LRT, assess significance using a p-value. 
